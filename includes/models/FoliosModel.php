...
class FoliosModel {
    ...
    public static $api_url_folios = 'https://apibeta.riosoft.cl/dtemanager/v1/cafs/folios/summary';
    public static $api_url_upload = 'https://apibeta.riosoft.cl/dtemanager/v1/cafs/upload';
    ...
    public static function request_api($url, $token) {
